        ...
        <div class="table-responsive-sm">
            ...
            <form action="/addSubCategory">
                <div class="form-group">
                    <div class="col-6">
                        <label for="subCategory" class="col-form-label-sm">New Category:</label>
                        <input type="ID" class="form-control col-form-label-sm" id="subCategory" name="subCategory"
            ...
            <br>
            <form action="/deleteSubCategoryById">
                <div class="form-group">
                    <div class="col-6">
